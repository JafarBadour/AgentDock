...
void main() {
  group('TranscriptWindow.sync', () {
    test('small transcript starts at 0', () {
      final w = TranscriptWindow(pageSize: 10);
      w.visibleCount = 10;
      w.start = 5;
  ...
  group('TranscriptWindow.pinToLatest', () {
    ...
    test('small lists start at 0', () {
      final w = TranscriptWindow(pageSize: 10)..visibleCount = 40;
      w.pinToLatest(5);
      expect(w.start, 0);
    });
  });
  ...
  group('TranscriptWindow.visibleSlice / hidden', () {
    ...
    test('tail slice never hides newer rows', () {
      final w = TranscriptWindow(pageSize: 5)
        ..visibleCount = 5
        ..pinnedToEnd = false;
  ...
  group('TranscriptWindow.loadOlder', () {
    ...
    test('loads one page and reports count', () {
      final w = TranscriptWindow(pageSize: 10, cooldown: Duration.zero);
  ...
  group('TranscriptWindow.preserveScrollAfterPrepend', () {
    final w = TranscriptWindow();

    test('keeps thumb on the same content', () {
