...
void main() {
  group('adsm version helpers', () {
    test('compare and meets', () {
      ...
      expect(adsmVersionMeets('0.4.17', kRequiredAdsmVersion), isFalse);
      expect(adsmVersionMeets('0.4.18', kRequiredAdsmVersion), isTrue);
    ...
    test('required version matches protocol bump', () {
      expect(kRequiredAdsmVersion, '0.4.18');
    });
  });
}
